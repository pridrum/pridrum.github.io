...
## I teach by listening, and then by changing the course
...
told me the slides moved faster than their thinking. I replaced generic examples with cases
...
told me why: transitions between topics were too abrupt, the balance tipped toward theory over
applied practice, and the assigned textbook hindered more than it helped. That criticism was
fair, and it is the reason for the changes above. I would rather run a course that visibly
improves under criticism than one that is defended.
...
## Teaching students what a model leaves out
